...
def check_dependencies():
    ...
    required_packages = [
        ...
        'pydantic', 'scikit-learn', 'sentence-transformers',
...
def main():
    ...
    parser.add_argument("--mode", choices=["api", "dashboard", "both", "test"], 
                       default="both", help="What to run")
    ...
    try:
        if args.mode == "test":
            ...
            # Start API server
            api_process = run_api_server(args.api_host, args.api_port, not args.no_reload)
            if api_process:
